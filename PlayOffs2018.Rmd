...
```{r}
boxplot(c(HOURa, CLERa, HOURs, CLERs), horizontal = TRUE, names = c("HOU.RA", "CLE.RA", "HOU.Rs", "CLE.Rs"), main = "Astros/Indians", sub = "Runs Scored vs. Runs Allowed", col = c( "#EB6E1F", "#E31937", "#EB6E1F", "#E31937"), notch = TRUE, outline = FALSE, border = "#0C2340")
```
...
####Miluake '18 Season and Colorado '18 Season

```{r}
boxplot(c(COLRa, MILRa, COLRs, MILRs), horizontal = TRUE, names = c("COL.RA", "MIL.RA", "COL.Rs", "MIL.Rs"), main = "Brewers/Rockies", sub = "Runs Scored vs. Runs Allowed", col = c( "#33006F", "#0A2351", "#33006F", "#0A2351"), notch = TRUE, outline = FALSE, border = "#85714D")
```
...
####Brewers vs Rockies '18

```{r}
boxplot(c(COLvMIL, MILvCOL), horizontal = TRUE, names = c("COL", "MIL"), main = "MIL vs COL '18", sub = "Runs Scored against eachother", col = c("#33006F", "#0A2351"), border = "#85714D")
...
```{r}
print("Brandon Woodruff")
sabermtrkk.WP(BWmilRs, BWmilRa)
print("Antonio Senzatela")
...
###Dodgers and Braves 2018

```{r}
boxplot(c(LADRa, ATLRa, LADRs, ATLRs), horizontal = TRUE, names = c("LAD.RA", "ATL.RA", "LAD.Rs", "ATL.Rs"), main = "Dodgers/Braves", sub = "Runs Scored vs. Runs Allowed", col = c( "#005A9C", "#CE1141", "#005A9C", "#CE1141"), notch = TRUE, outline = FALSE, border = "#A5ACAF")
```



#Dodgers Vs. Braves 2018
```{r}
#Brewers Vs. Rockies 2018
LAD18ATL     <- mlb_elo %>%
  select(date, season, playoff, team1, team2, pitcher1, pitcher2, score1, score2) %>%
...
```{r}
boxplot(c(ATLvLAD, LADvATL), horizontal = TRUE, names = c("ATL", "LAD"), main = "ATL vs LAD '18", sub = "Runs Scored against eachother", col = c("#CE1141", "#005A9C"), border = "#A5ACAF")
```


####Thursday @ Atlanta Arena
#####*Hyun-Jin Ryu vs Hyun-Jin Ryu*

```{r}
print("Hyun-Jin Ryu")
sabermtrkk.WP(HRladRs, HRladRa)
print("Mike Foltynewicz")
