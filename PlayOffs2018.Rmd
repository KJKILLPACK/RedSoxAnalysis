...
```{r}
print("Mike Clevinger (CLE)")
sabermtrkk.WP(MCcleRs, MCcleRa)
print("Dallas Keuchel (HOU)")
...
```{r}
print("Walker Buehler (LAD)")
PitcherSBWsea.KBS("Walker Buehler", "2018")
print("Sean Newcomb (ATL")
